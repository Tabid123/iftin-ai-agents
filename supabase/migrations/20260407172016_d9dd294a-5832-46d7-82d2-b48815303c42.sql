...
-- Fix get_admin_analytics_summary to use correct profit formula
...
BEGIN
  ...
  SELECT json_build_object(
    'total_revenue', COALESCE(SUM(o.selling_price), 0),
    'total_cost', COALESCE(SUM(o.cost_price), 0),
    'total_profit', COALESCE(SUM((o.selling_price * (1 + COALESCE(pc.evoucher_rate, 0))) - o.cost_price), 0),
    'total_orders', COUNT(*),
    ...
    'today', json_build_object(
      'revenue', COALESCE(SUM(o.selling_price) FILTER (WHERE o.created_at >= today_start), 0),
      'cost', COALESCE(SUM(o.cost_price) FILTER (WHERE o.created_at >= today_start), 0),
      'profit', COALESCE(SUM((o.selling_price * (1 + COALESCE(pc.evoucher_rate, 0))) - o.cost_price) FILTER (WHERE o.created_at >= today_start), 0),
    ...
    'week', json_build_object(
      'revenue', COALESCE(SUM(o.selling_price) FILTER (WHERE o.created_at >= week_start), 0),
      'cost', COALESCE(SUM(o.cost_price) FILTER (WHERE o.created_at >= week_start), 0),
      'profit', COALESCE(SUM((o.selling_price * (1 + COALESCE(pc.evoucher_rate, 0))) - o.cost_price) FILTER (WHERE o.created_at >= week_start), 0),
    ...
    'month', json_build_object(
      'revenue', COALESCE(SUM(o.selling_price) FILTER (WHERE o.created_at >= month_start), 0),
      'cost', COALESCE(SUM(o.cost_price) FILTER (WHERE o.created_at >= month_start), 0),
      'profit', COALESCE(SUM((o.selling_price * (1 + COALESCE(pc.evoucher_rate, 0))) - o.cost_price) FILTER (WHERE o.created_at >= month_start), 0),
    ...
    'year', json_build_object(
      'revenue', COALESCE(SUM(o.selling_price) FILTER (WHERE o.created_at >= year_start), 0),
      'cost', COALESCE(SUM(o.cost_price) FILTER (WHERE o.created_at >= year_start), 0),
      'profit', COALESCE(SUM((o.selling_price * (1 + COALESCE(pc.evoucher_rate, 0))) - o.cost_price) FILTER (WHERE o.created_at >= year_start), 0),
...
-- Fix get_admin_transactions_summary
...
BEGIN
  ...
  SELECT json_build_object(
    ...
    'sales_today', COALESCE(SUM(o.selling_price) FILTER (WHERE o.created_at >= date_trunc('day', now())), 0),
    'sales_this_month', COALESCE(SUM(o.selling_price) FILTER (WHERE o.created_at >= date_trunc('month', now())), 0),
    'total_profit', COALESCE(SUM((o.selling_price * (1 + COALESCE(pc.evoucher_rate, 0))) - o.cost_price), 0),
...
-- Fix get_admin_transactions_paginated
...
-- Fix get_admin_date_range_breakdown
...
BEGIN
  ...
  FROM (
    SELECT date_trunc('day', o.created_at)::date as day_date,
      ...
      COALESCE(SUM((o.selling_price * (1 + COALESCE(pc.evoucher_rate, 0))) - o.cost_price), 0) as profit
    FROM orders o
    LEFT JOIN providers_config pc ON o.provider_id = pc.id
...
-- Fix get_admin_provider_daily_stats
